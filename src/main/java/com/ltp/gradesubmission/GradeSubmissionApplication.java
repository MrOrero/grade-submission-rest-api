...
public class GradeSubmissionApplication {
	...
	// "In this class, you will learn spells concerned with giving an object new and
	...
	// "In this class, you will learn the study of magical plants and how to take
	// care of, utilise and combat them."),
	// new Course("History of Magic", "HIS393",
	// "In this class, you will learn about significant events in wizarding
	// history."),
	// new Course("Potions", "POT102",
	// "In this class, you will learn correct mixing and stirring of ingredients to
	// create mixtures with magical effects."),
	// new Course("Transfiguration", "TR442",
	// "In this class, you will learn the art of changing the form or appearance of
	// an object.")
	// };
